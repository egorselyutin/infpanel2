...
.contacts-info-card {{
    background-color: #f8f9fa; border-left: 5px solid rgb(255, 75, 75);
...
.back-btn-container div.stButton > button:hover {{ border-color: rgb(255, 75, 75) !important; color: rgb(255, 75, 75) !important; }}
.back-btn-container div.stButton > button:hover p,
.back-btn-container div.stButton > button:hover span {{ color: rgb(255, 75, 75) !important; }}
...
.svg-wrapper svg.first-load {{ animation: mapEntrance 0.8s ease-out forwards; }}
